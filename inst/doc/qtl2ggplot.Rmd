...
```{r}
scan_pat <- qtl2pattern::scan_pattern(pr, DOex$pheno, NULL, NULL, patterns)
```

```{r}
plot(scan_pat, xlim=c(85,125)) + ggplot2::geom_vline(xintercept = c(96.5,98.5))
```

```{r}
plot(scan_pat, "coef", xlim = c(50,150)) + 
